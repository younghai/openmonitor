...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="{alert_url}" class="button">View in Vtstirele</a>
        </div>
        <div class="footer">
            This alert was generated automatically by Vtstirele. Do not reply to this email.
        </div>
    </div>
</body>
</html>`,
  type: 'email' as const,
  title: 'Vtstirele Alert Notification',
  isDefault: false
};
