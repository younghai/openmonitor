...
describe("CreateDestinationForm", () => {
  ...
  describe("Component Initialization", () => {
    ...
    it("should have Vtstirele as default destination type", () => {
      expect(wrapper.vm.formData.destination_type).toBe("openobserve");
    });

    it("should initialize with default Vtstirele headers", () => {
    ...
    it("should have Vtstirele default url_endpoint", () => {
  ...
  describe("Destination Type Selection", () => {
    ...
    it("should show images for non-custom destination types", async () => {
      ...
      expect(img.attributes("alt")).toBe("Vtstirele");
    });
  ...
  describe("URL Endpoint Prefilling", () => {
    it("should prefill correct endpoint for Vtstirele", async () => {
  ...
  describe("Method Field Behavior", () => {
    it("should hide Method field for Vtstirele", async () => {
      wrapper.vm.formData.destination_type = "openobserve";
      wrapper.vm.step = 2;
      await wrapper.vm.$nextTick();
      await flushPromises();
  ...
  describe("Output Format Field Behavior", () => {
    it("should disable Output Format field for Vtstirele", async () => {
      wrapper.vm.formData.destination_type = "openobserve";
  ...
  describe("Default Headers Functionality", () => {
    it("should set correct headers for Vtstirele", async () => {
      wrapper.vm.formData.destination_type = "openobserve";
      await wrapper.vm.$nextTick();
  ...
  describe("Form Reset", () => {
    ...
    it("should reset headers to Vtstirele defaults", () => {
  ...
  describe("Connection Notes", () => {
    it("should display correct connection notes for Vtstirele", () => {
      wrapper.vm.formData.destination_type = "openobserve";

      const notes = wrapper.vm.connectionNotes;
      expect(notes.title).toContain("Vtstirele");
  ...
  describe("Destination Metadata", () => {
    ...
    it("should not require metadata for Vtstirele", async () => {
      wrapper.vm.formData.destination_type = "openobserve";
      wrapper.vm.formData.name = "test";
      wrapper.vm.formData.url = "https://example.com";
      wrapper.vm.formData.url_endpoint = "/api/org/stream/_json";
