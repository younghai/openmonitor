...
describe("Header Component", () => {
  ...
  describe("Logo Rendering", () => {
    it("should display Vtstirele logo by default", async () => {
      ...
      // Verify the Vtstirele logo is rendered
    ...
    it("should not display Vtstirele logo when custom_hide_self_logo is true", async () => {
      const customWrapper = createWrapper({
        mountType: 'mount',
        storeOverrides: {
          state: {
      ...
      // Check that the Vtstirele logo is NOT in the HTML
    ...
    it("should display Vtstirele logo when custom_hide_self_logo is false", async () => {
      const customWrapper = createWrapper({
        mountType: 'mount',
        storeOverrides: {
          state: {
      ...
      // Check that the Vtstirele logo IS in the HTML
      const openobserveLogo = customWrapper.find('.openobserve-logo');
      expect(openobserveLogo.exists()).toBe(true);
  ...
  describe("Edge Cases", () => {
    ...
    it("should render default Vtstirele logo when both custom logos are null", () => {
      const wrapper = createWrapper({
        mountType: 'mount',
        storeOverrides: {
          state: {
      ...
      // Verify default Vtstirele logo is rendered instead
