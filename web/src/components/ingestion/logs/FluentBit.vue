...
<template>
  ...
  <div>
    <a
      ...
      target="_blank"
      title="Harnessing the Power of FluentBit to Stream Kubernetes Logs to Vtstirele!"
    >
      Click here</a
    >
    to explore the process of sending logs from Kubernetes to Vtstirele using
    FluentBit.
  </div>
</template>
