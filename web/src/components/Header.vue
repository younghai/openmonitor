...
<template>
  <q-toolbar>
    <!-- LOGO SECTION: Displays custom or default Vtstirele logo -->
    ...
    >
      ...
      <!-- Vtstirele logo (shown alongside custom logo if configured) -->
      <div
    ...
    <!-- Default Vtstirele logo (when no custom logo) -->
